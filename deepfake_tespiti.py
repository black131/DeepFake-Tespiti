...
Original file is located at
    https://colab.research.google.com/drive/1s3YyUhHVF---cOXHzuTD4UQPTmE9K-6u
"""
...
class ModelXception(BaseModel):
    def __init__(self):
        ...
        self.pool = nn.AdaptiveAvgPool2d((1, 1)) # Şimdi hata vermez
...
if __name__ == "__main__":
    try:
        ...
        # A. Veri Hazırlığı
        (X_tr, y_tr), (X_val, y_val), (X_te, y_te) = load_and_split_data()

        train_transforms = transforms.Compose([
            transforms.Resize((Config.IMG_SIZE, Config.IMG_SIZE)),

            # Geometrik Bozulmalar
            transforms.RandomHorizontalFlip(p=0.5),
            transforms.RandomRotation(degrees=15),
            transforms.RandomAffine(degrees=0, translate=(0.1, 0.1)),

            # Görüntü Kalitesi Bozulmaları
        ...
        train_ds = DualDomainDataset(X_tr, y_tr, train_transforms)
        test_ds = DualDomainDataset(X_te, y_te, test_transforms)
